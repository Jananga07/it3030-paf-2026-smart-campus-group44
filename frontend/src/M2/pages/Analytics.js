...
export default function Analytics() {
  ...
  if (loading) return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      <AdminSidebar />
      <p className="flex-1 text-center py-20 text-gray-400">Loading analytics...</p>
    </div>
  );
  ...
  if (error) return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      <AdminSidebar />
      <p className="flex-1 text-center py-20 text-red-500">{error}</p>
    </div>
  );
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      <div className="flex-1 bg-gradient-to-br from-indigo-50 to-blue-100">
